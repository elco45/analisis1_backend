var room = require('../schemas/room');/*objetos q se van a volver tablas, ayuda a crud el bd*/
var user = require('../schemas/user');/*objetos q se van a volver tablas, ayuda a crud el bd*/
